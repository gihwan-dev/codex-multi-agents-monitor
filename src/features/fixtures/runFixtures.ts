import { type AgentLane, type ArtifactRecord, calculateSummaryMetrics, type EdgeRecord, type EventRecord, type LiveWatchFrame, type RunDataset } from "../../shared/domain/index.js";
