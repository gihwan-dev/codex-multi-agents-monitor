...
function buildSummarySection(summary: InspectorCausalSummary | null): InspectorSectionConfig {
  return {
    key: "summary",
    title: "Summary",
...
function buildDirectCauseSection(
...
function buildDownstreamSection(
  summary: InspectorCausalSummary,
  onSelectJump: (selection: SelectionState) => void,
) {
...
function buildNextActionSection(summary: InspectorCausalSummary) {
